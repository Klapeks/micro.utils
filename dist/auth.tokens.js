                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (req.headers.authorization) {
                            throw new exceptions_1.HttpException("Auth token expired", exceptions_1.HttpStatus.UNAUTHORIZED);
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        e_1 = _a.sent();
                        throw new exceptions_1.HttpException("Unauthorized", exceptions_1.HttpStatus.UNAUTHORIZED);
                    case 4: return [2];
                }
            });
        });
